...
#		notify => 'ZSHRC for openbsd has been deployed'
	...
	file { '/root/.vimrc'	:	source => 'puppet:///modules/openbsd/files/vimrc1', owner => 'root', mode => 0644, }
	file { '/root/.oh-my-zsh'	: source => 'puppet:///modules/openbsd/files/oh-my-zsh', owner => 'root', ensure => directory, recurse => true, force => true, mode => 0644,  }
